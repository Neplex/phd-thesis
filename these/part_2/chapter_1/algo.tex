\begin{algorithm}[H]
    \caption{$\textsf{ALGO}(T = (D, l), epochs, \tau, minSupport)$}
    ...
    \While{$i \leq \text{epochs}$ and $simp$}{
        ...
        \tcp{Supprimer les noeuds redondants}
...
\begin{algorithm}
    \caption{$\textsf{findGroups}(T = (D, l), \tau, minSupport)$}
...
\begin{algorithm}
    \caption{$\textsf{findSubgroups}(T = (D, l), minSupport)$}
...
\begin{algorithm}
    \caption{$\textsf{mergeGroups}(T = (D, l), minSupport)$}
    \SetKwData{groupFound}{groupFound}
    \SetKwData{st}{st}
...
\begin{algorithm}
    \caption{$\textsf{findRelationship}(T = (D, l), minSupport)$}
...
\begin{algorithm}
    \caption{findCollections($T = (D, l), \text{minSupport}$)}
