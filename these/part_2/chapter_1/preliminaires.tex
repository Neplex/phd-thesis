...
\begin{example}[Règle de réécriture]
    ...
    $U$ représente le nœud à la position $u$ de l'arbre cible, $x \in V$ est une variable et $X, Y, A, B, C, D \in \Sigma$ représentent des étiquettes (des non-terminaux) de l'arbre.
