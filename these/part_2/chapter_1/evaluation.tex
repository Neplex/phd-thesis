...
\begin{figure}[htb]
    ...
    \begin{tikzpicture}
        \begin{groupplot}[
                ...
                tickpos=left,
                legend columns=-1,
                legend style={draw=none, at={(0.5,-0.2)}, anchor=north},
                width=\textwidth,
            ]
            ...
            \nextgroupplot[ybar, ymin=0, ymax=9, ylabel={Opération}, pattern=crosshatch, height=.15\textheight, bar width=.5em]
...
\begin{figure}[htb]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot+[mark=triangle*] table [x expr={1 + \thisrow{step}}, y=value, col sep=comma] {these/part_2/chapter_1/eval/group_ratio.csv}; \label{figure:struct:xp:ratio:group}
            ...
            \addplot+[mark=square*] table [x expr={1 + \thisrow{step}}, y=value, col sep=comma] {these/part_2/chapter_1/eval/rel_ratio.csv}; \label{figure:struct:xp:ratio:rel}
            ...
            \addplot+[mark=+] table [x expr={1 + \thisrow{step}}, y=value, col sep=comma] {these/part_2/chapter_1/eval/coll_ratio.csv}; \label{figure:struct:xp:ratio:coll}
