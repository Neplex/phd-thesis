...
Cependant, la construction de l'ensemble \textsf{LinkedNull} ne peux être exprimée par une unique requête \gls{sql} et est donc réalisée par la procédure~\ref{algo:update:mysql:partition}.
