...
Dans un second temps, nous nous concentrons sur la structuration d'informations extraites de documents textuels, une source de données majeure dans le domaine médical.
...
In a second hand, we focus on the structuration of information extracted from text documents, a major source of data in the medical field.
